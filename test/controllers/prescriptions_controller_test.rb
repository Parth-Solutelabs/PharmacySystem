...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { deliverdate: @prescription.deliverdate, delivered: @prescription.delivered, dosage: @prescription.dosage, drug_name: @prescription.drug_name, patient_name: @prescription.patient_name, pharmacist_id: @prescription.pharmacist_id, presid: @prescription.presid, quantity: @prescription.quantity } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { deliverdate: @prescription.deliverdate, delivered: @prescription.delivered, dosage: @prescription.dosage, drug_name: @prescription.drug_name, patient_name: @prescription.patient_name, pharmacist_id: @prescription.pharmacist_id, presid: @prescription.presid, quantity: @prescription.quantity } }
