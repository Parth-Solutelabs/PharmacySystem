...
class PrescriptionsTest < ApplicationSystemTestCase
  ...
  test "creating a Prescription" do
    ...
    fill_in "Deliverdate", with: @prescription.deliverdate
    check "Delivered" if @prescription.delivered
    fill_in "Dosage", with: @prescription.dosage
    fill_in "Drug name", with: @prescription.drug_name
    fill_in "Patient name", with: @prescription.patient_name
    fill_in "Pharmacist", with: @prescription.pharmacist_id
    fill_in "Presid", with: @prescription.presid
    fill_in "Quantity", with: @prescription.quantity
